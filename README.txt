...
This package contains the implementations of the Client and its various directly linked helper classes.
	...
	This class is a Timer Task that utilises a timer and subscribes itself to it. This class utilises an interval of AppConstants.STATS_LOGGER_INTERVAL_MILLIS(which is set to 20 seconds) in order to 	schedule the printing of Client Statistics at regular intervals.
...
This package contains the implementations of the Server and its various directly linked helper classes.
	...
	This class is a Timer Task that utilises a timer and subscribes itself to it. This class utilises an interval of AppConstants.STATS_LOGGER_INTERVAL_MILLIS(which is set to 20 seconds) in order to 	schedule the printing of Server Statistics at regular intervals.
